...
public class DataHandler extends SQLiteOpenHelper {
    ...
    public void addDataHandler(Students student) {
    ...
    public Students findFisrtDataHandler(String studentname) {
    ...
    public List<Students> findAllDataHandler(String studentname) {
        //chuỗi truy vấn tìm kiếm Student theo StudentName
        String query = "Select * FROM " + TABLE_NAME
                + " WHERE " + COLUMN_NAME + " = "
                + "'" + studentname + "'";
